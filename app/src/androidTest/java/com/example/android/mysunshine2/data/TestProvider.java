 ...
 */
package com.example.android.mysunshine2.data;
...
import com.example.android.mysunshine2.data.WeatherContract.LocationEntry;
   ...
   public void testBasicWeatherQuery() {
    ...
    public void testUpdateLocation() {
        ...
        int count = mContext.getContentResolver().update(
                LocationEntry.CONTENT_URI, updatedValues, LocationEntry._ID + "= ?", new String[] { Long.toString(locationRowId)});
