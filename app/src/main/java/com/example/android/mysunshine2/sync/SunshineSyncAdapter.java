package com.example.android.mysunshine2.sync;
...
import com.example.android.mysunshine2.R;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        fetchDataFromServer(makeQueryInfo());
    }

    private String[] makeQueryInfo() {
    ...
    private String getSharedPreferencePeriod(){
        ...
        String period = sharedPref.getString(mContext.getString(R.string.pref_period_key), mContext.getString(R.string.pref_period_default));
        Log.d(LOG_TAG, "Period preference: "+ period);
    ...
    private String getSharedPreferenceTempUnit(){
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(mContext);
        String unit = sharedPref.getString(mContext.getString(R.string.pref_temp_key), mContext.getString(R.string.pref_temp_default));
        Log.d(LOG_TAG, "Temperature preference: "+ unit);
    ...
    private String getSharedPreferenceLocation(){
        ...
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(mContext);
        String location = sharedPref.getString(mContext.getString(R.string.pref_location_key), mContext.getString(R.string.pref_location_default));
        Log.d(LOG_TAG, "Location preference: "+ location);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                int insertedCount = mContentResolver.bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, cvArray);
                Log.d(LOG_TAG, "Weather data are inserted: Vector size:  "+cVVector.size()+ " Inserted size: "+insertedCount);
            }


            Log.d(LOG_TAG, "getWeatherDataFromJson Complete. " + cVVector.size() + " Inserted");
...
//            return resultStrs;
    ...
    private long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(locationCursor.moveToFirst()){
            ...
            Uri insertedUri = mContentResolver.insert(WeatherContract.LocationEntry.CONTENT_URI, locationValues);
    ...
    public static void syncImmediately(Context context) {
        ...
        //bundle.putStringArray(QUERY_INFO, queryInfo);
